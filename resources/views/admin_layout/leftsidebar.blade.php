      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{  request()->is('sliders') ? 'menu-open' : ''}}  {{  request()->is('addslider') ? 'menu-open' : ''}}">
            <a href="{{url('/sliders')}}" class="nav-link {{ request()->is('sliders') ? 'active' : '' }} {{ request()->is('addslider') ? 'active' : '' }}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Sliders
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item has-treeview  {{  request()->is('orders') ? 'menu-open' : ''}} ">
            ...
            <ul class="nav nav-treeview  {{  request()->is('orders') ? 'menu-open' : ''}} ">
              <li class="nav-item ">
                <a href="{{url('/orders')}}" class="nav-link  {{  request()->is('orders') ? 'menu-open' : ''}}">
                  <i class="far fa-file nav-icon"></i>
                  <p>Orders</p>
                </a>
              </li>
